...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-cnpm/node_modules/cnpm/help.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-cnpm/node_modules/cnpm/help.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-cnpm/node_modules/cnpm/</a> &#187; help.js</div>
</div>
<div class="body">
...
module.exports = function outputHelp(argv) {
  ...
  '\n' +
  '  npm command use --registry=' + (argv.registry || <span class="branch-1 cbranch-no" title="branch not covered" >config.cnpmRegistry)</span> + '\n' +
...
&nbsp;
  ...
  '          ' + (argv.userconfig || <span class="branch-1 cbranch-no" title="branch not covered" >config.userconfig)</span> + '\n' +
